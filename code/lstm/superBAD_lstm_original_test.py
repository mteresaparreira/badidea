                            ...
                            for epoch in epochs:
                                for i, batch_size in enumerate(batch_sizes):
                                    try:
                                        ...
                                        print(f'Shape of X_train_sequences: {np.array(X_train_sequences).shape}')
                                        print(f'Shape of y_train_sequences: {np.array(y_train_sequences).shape}')
                                        print(f'Shape of X_val_sequences: {np.array(X_val_sequences).shape}')
                                        print(f'Shape of y_val_sequences: {np.array(y_val_sequences).shape}')
                                        print(f'Shape of X_test_sequences: {np.array(X_test_sequences).shape}')
                                        print(f'Shape of y_test_sequences: {np.array(y_test_sequences).shape}')
                                        """
                                        ------------------------------------------------------------------------------------
